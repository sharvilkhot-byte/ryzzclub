...
interface DeepConversationScreenProps {
  onNext: (rating: string) => void;
  onBack: () => void;
}

export function DeepConversationScreen({ onNext, onBack }: DeepConversationScreenProps) {
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>29</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-8 md:mb-12">
            How much of a deep conversation lover are you?*
          </h1>

          {/* Scale labels */}
          <div className="flex justify-between mb-12 md:mb-16">
            <span className="typeform-subtext">
              0: Not a fan
            </span>
            <span className="typeform-subtext">
              10: I can go on for hours
            </span>
          </div>
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
              {ratings.map((rating) => (
                <button
                  ...
                  className={`typeform-option-box w-10 h-10 md:w-12 md:h-12 rounded-lg transition-all duration-200 flex items-center justify-center`}
                  style={{ 
