...
interface DinnerBudgetScreenProps {
  onNext: (budget: string) => void;
  onBack: () => void;
}

export function DinnerBudgetScreen({ onNext, onBack }: DinnerBudgetScreenProps) {
  ...
  const options = [
    { id: '500-1000', label: '500-1000', letter: 'A' },
    { id: '1000-1500', label: '1000-1500', letter: 'B' },
    { id: '1500+', label: '1500+', letter: 'C' },
    { id: 'Other', label: 'Other', letter: 'D' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>12</span>
          </div>
