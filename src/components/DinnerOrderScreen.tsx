...
interface DinnerOrderScreenProps {
  onNext: (order: string) => void;
  onBack: () => void;
}

export function DinnerOrderScreen({ onNext, onBack }: DinnerOrderScreenProps) {
  ...
  const options = [
    { id: 'Something I\'ve tried before', label: 'Something I\'ve tried before', letter: 'A' },
    { id: 'Comfort food', label: 'Comfort food', letter: 'B' },
    { id: 'Classic and simple', label: 'Classic and simple', letter: 'C' },
    { id: 'Experimental & new', label: 'Experimental & new', letter: 'D' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>16</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            At dinner, what do you usually order?*
          </h1>
