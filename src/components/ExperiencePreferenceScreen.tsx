...
interface ExperiencePreferenceScreenProps {
  onNext: (preference: string) => void;
  onBack: () => void;
}

export function ExperiencePreferenceScreen({ onNext, onBack }: ExperiencePreferenceScreenProps) {
  ...
  const options = [
    { id: 'try-it-out', label: "I'm a try it out kinda person", letter: 'A' },
    { id: 'research-first', label: 'I like to read and research everything before I try them.', letter: 'B' },
    { id: 'freak-me-out', label: 'New experiences freak me out!', letter: 'C' },
    { id: 'too-cool', label: "I'm too cool for new things", letter: 'D' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>23</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            How do you prefer experiencing new things?*
          </h1>
