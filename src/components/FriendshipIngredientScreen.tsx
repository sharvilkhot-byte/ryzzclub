...
interface FriendshipIngredientScreenProps {
  onNext: (ingredient: string) => void;
  onBack: () => void;
}

export function FriendshipIngredientScreen({ onNext, onBack }: FriendshipIngredientScreenProps) {
  ...
  const options = [
    { id: 'Loyalty', label: 'Loyalty', letter: 'A' },
    { id: 'Humor', label: 'Humor', letter: 'B' },
    { id: 'Trust', label: 'Trust', letter: 'C' },
    { id: 'Kindness', label: 'Kindness', letter: 'D' },
    { id: 'Adventure', label: 'Adventure', letter: 'E' },
    { id: 'Depends', label: 'Depends', letter: 'F' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>20</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-8 md:mb-12">
            If friendship was a recipe, your secret ingredient would be?*
          </h1>
