...
interface GoToOutfitScreenProps {
  onNext: (outfit: string) => void;
  onBack: () => void;
}

export function GoToOutfitScreen({ onNext, onBack }: GoToOutfitScreenProps) {
  ...
  const options = [
    { id: 'Jeans and a baggy t-shirt', label: 'Jeans and a baggy t-shirt', letter: 'A' },
    { id: 'Comfortable Athleisure', label: 'Comfortable Athleisure', letter: 'B' },
    { id: 'A Sharp Outfit', label: 'A Sharp Outfit', letter: 'C' },
    { id: 'Something Dressy', label: 'Something Dressy', letter: 'D' },
    { id: 'First thing I find.', label: 'First thing I find.', letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>18</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            You're in a hurry, you're late - what's your go to outfit?*
          </h1>
