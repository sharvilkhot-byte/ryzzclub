...
interface RiskTakingScreenProps {
  onNext: (choice: string) => void;
  onBack: () => void;
}

export function RiskTakingScreen({ onNext, onBack }: RiskTakingScreenProps) {
  ...
  const options = [
    { id: 'reward-high', label: 'The reward is high', letter: 'A' },
    { id: 'have-support', label: 'I have support', letter: 'B' },
    { id: 'feel-confident', label: 'I feel confident', letter: 'C' },
    { id: 'calculated-risk', label: "It's a calculated risk", letter: 'D' },
    { id: 'curious', label: "I'm curious", letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>28</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            You're more likely to take a risk if*
          </h1>
