...
interface SoundtrackScreenProps {
  onNext: (soundtrack: string) => void;
  onBack: () => void;
}

export function SoundtrackScreen({ onNext, onBack }: SoundtrackScreenProps) {
  ...
  const options = [
    { id: 'Bollywood all the way!', label: 'Bollywood all the way!', letter: 'A' },
    { id: 'Hard metal only', label: 'Hard metal only', letter: 'B' },
    { id: 'Pops at the Top', label: 'Pops at the Top', letter: 'C' },
    { id: 'Indian Classical', label: 'Indian Classical', letter: 'D' },
    { id: 'I like to Experiment', label: 'I like to Experiment', letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>14</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            If your life had a soundtrack, it would be?*
          </h1>
