...
interface TrySomethingNewScreenProps {
  onNext: (choice: string) => void;
  onBack: () => void;
}

export function TrySomethingNewScreen({ onNext, onBack }: TrySomethingNewScreenProps) {
  ...
  const options = [
    { id: 'encouraged-friends', label: 'When encouraged by friends', letter: 'A' },
    { id: 'aligns-interests', label: 'When it aligns with my interests', letter: 'B' },
    { id: 'challenges-me', label: 'When it challenges me', letter: 'C' },
    { id: 'have-time', label: 'When I have time', letter: 'D' },
    { id: 'spontaneous', label: "When it's spontaneous", letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>26</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-6 md:mb-8">
            You're most likely to try something new?*
          </h1>
