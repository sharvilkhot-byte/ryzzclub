...
export function VibeScreen({ onNext, onBack }: VibeScreenProps) {
  ...
  const options = [
    { id: 'Expresso shot', label: 'Expresso shot', letter: 'A' },
    { id: 'Green Tea', label: 'Green Tea', letter: 'B' },
    { id: 'A Wild Cocktail', label: 'A Wild Cocktail', letter: 'C' },
    { id: 'Protein Smoothie', label: 'Protein Smoothie', letter: 'D' },
    { id: 'H2O', label: 'H2O', letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>13</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            Imagine your vibe is a drink, which one would you choose?*
          </h1>
