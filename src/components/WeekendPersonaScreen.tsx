...
interface WeekendPersonaScreenProps {
  onNext: (persona: string) => void;
  onBack: () => void;
}

export function WeekendPersonaScreen({ onNext, onBack }: WeekendPersonaScreenProps) {
  ...
  const options = [
    { id: 'The Club hopper', label: 'The Club hopper', letter: 'A' },
    { id: 'The Netflix in Bed expert', label: 'The Netflix in Bed expert', letter: 'B' },
    { id: 'Too busy for weekends!', label: 'Too busy for weekends!', letter: 'C' },
    { id: 'The Side hustler', label: 'The Side hustler', letter: 'D' },
    { id: 'The beer and chiller', label: 'The beer and chiller', letter: 'E' }
  ];
      ...
      <div className="flex flex-col justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-2xl mx-auto w-full md:mx-0 md:ml-8 lg:ml-16">
          ...
          <div className="flex items-center mb-6 md:mb-8">
            ...
            <span className="text-lg md:text-xl" style={{ color: '#5f4cdc' }}>17</span>
          </div>

          {/* Main question */}
          <h1 className="typeform-main-question mb-12 md:mb-16">
            Your weekend persona is?*
          </h1>
